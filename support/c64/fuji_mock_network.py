...
# To test in Vice, point drive 11 to the following directory:
# Then run: make c64 VICE=1
# The app will then save/read appkeys from this folder and call this bridge for network access
